...
def download_file(url, output, quiet=False):
...
def build_model():
    ...
    if not os.path.isfile(home + "/.deepface/weights/shape_predictor_5_face_landmarks.dat"):
        ...
        download_file(url, output, quiet=False)
    ...
    detector = {"face_detector": face_detector, "sp": sp}
    return detector
